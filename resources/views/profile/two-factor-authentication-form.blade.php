<x-action-section>
    ...
    <x-slot name="description">
        {{ __('Renforcez la sécurité de votre compte en utilisant l\'authentification à deux facteurs.') }}
    </x-slot>
    ...
    <x-slot name="content">
        ...
        <div class="mt-3 max-w-xl text-sm text-gray-600">
            <p>
                {{ __('Lorsque l\'authentification à deux facteurs est activée, vous devrez entrer un jeton sécurisé et aléatoire lors de l\'authentification. Vous pouvez obtenir ce jeton à partir de l\'application Google Authenticator de votre téléphone.') }}
            </p>
        </div>
